...
def run_compute_entropy(logits: torch.Tensor) -> torch.Tensor:
    ...
    from cs336_alignment.task import compute_entropy
...
def run_sft_microbatch_train_step(
    ...
    """
    from cs336_alignment.task import sft_microbatch_train_step
...
def run_masked_normalize(
    ...
    """
    from cs336_alignment.task import masked_normalize
